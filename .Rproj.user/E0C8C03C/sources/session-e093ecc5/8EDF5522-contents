...
#' small_sim <- simulate_shots_sbc(n_observations = 100, n_defenders = 20)
#'
#' # Generate a larger dataset with custom parameters
#' large_sim <- simulate_shots_sbc(
#'   n_observations = 5000,
#'   n_defenders = 100,
#'   n_teams = 15,
#'   seed = 123
